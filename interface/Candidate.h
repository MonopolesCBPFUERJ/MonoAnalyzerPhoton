...
public:
  ...
  MonoCandidate(double sh, double satsh, double dedxsig, double dedxsig_up, double dedxsig_down, double xyp0, double xyp1, double xyp2,
                ...
                double dist, double f51, double f15, double f51_up, double f51_down, 
      ...
      dist_(dist), f51_(f51), f15_(f15), f51_up_(f51_up), f51_down_(f51_down), e55_(e55), hIso_(hiso), 
  ...
  MonoCandidate(const MonoCandidate &mc) :
      ...
      dist_(mc.dist_), f51_(mc.f51_), f15_(mc.f15_), f51_up_(mc.f51_up_), f51_down_(mc.f51_down_), e55_(mc.e55_), hIso_(mc.hIso_),
